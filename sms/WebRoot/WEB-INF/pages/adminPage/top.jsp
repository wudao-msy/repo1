    	...
    	<div class="container">
	    	<div class="col-sm-12">
	    		<ul class="nav nav-pills">
				  <li class="active"><a href="/sysuser/toAdminMain.do">首&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;页</a></li>
				  ...
				  <li class="dropdown">
			          ...
			          <ul class="dropdown-menu">
			            <li><a class="btn btn-link" data-toggle="modal" data-target="#modfiyName" style="text-align: left;">更新个人信息</a></li>
